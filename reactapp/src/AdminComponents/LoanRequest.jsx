...
const LoanRequests = () => {
    ...
    async function fetchData() {
      try {
          const response = await axios.post('https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loanApplication/getAllLoanApplications',
          {
    ...
    async function handleApprove(id, userName, userId) {
      ...
      try {
          const response = await axios.put(
              `https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loanApplication/updateLoanApplication/${id}`,
              requestObject
          );
