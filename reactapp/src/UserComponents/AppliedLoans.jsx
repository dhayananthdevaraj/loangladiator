...
const AppliedLoansPage = () => {
    ...
    async function fetchData() {
        try {
            const response = await axios.get("https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loanApplication/getLoanApplicationByUserId/" + userId);
    ...
    async function handleConfirmDelete() {
            ...
            const response = await axios.delete(
                'https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loanApplication/deleteLoanApplication/' + loanToDelete
            );
            if (response.status === 200) {
                fetchData();
            }
