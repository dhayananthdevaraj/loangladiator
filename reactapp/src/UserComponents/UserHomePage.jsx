...
const UserHomePage = () => {
  ...
  try{
    const response = await axios.get(
      "https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loanApplication/getLoanApplicationByUserId/" +
        userId
    );
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
           "https://8080-abfdabeabcbaedabbafdecceeabfbcbffeb.premiumproject.examly.io/loan/getAllLoans"
      );
